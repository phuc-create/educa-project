...
define("SMTP_UNAME", "petlandsfamily@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "123456phucP"); //Password for SMTP authentication
