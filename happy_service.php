...
<body>
    ...
    <form method="post" action="happy_service.php">
    <div class="happy_service">
        <div class="container-happy-service">
        <div class="title">
            <h1>Đăng kí dịch vụ y tế</h1>
        </div>
        <div class="container-form-service">
            <div class="img-happy-service">
                <img id="full" src="img-vid/cat2.svg">
            </div>
            <div class="form-happy-service">
                <div class="input-hs">
                    <label>Tên Dịch Vụ</label>
                    <input type="Adress" name="ten" value="Dịch Vụ chăm sóc Thú Cưng" readonly="">
                </div>
                <div class="input-hs">
...
if (isset($_POST["submit"])){
   ...
   $ten_dv = $_POST["ten"];
   $mota_dv = $_POST["mota"];
   $sql = mysqli_query($con,"SELECT * from service WHERE ten_dv='Dịch Vụ chăm sóc Thú Cưng' AND id='$id'");
   ...
   if ($query==true) {
    header("refresh:1;url =happy_service.php");
